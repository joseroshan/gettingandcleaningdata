...
The data is present in data.zip

In R, from the directory in which the run_analysis.R is downloaded, run the below command:
...
The data output for Step 2 is located in the results folder as dataset1
and for Step 5 is located in the results folder as dataset2
